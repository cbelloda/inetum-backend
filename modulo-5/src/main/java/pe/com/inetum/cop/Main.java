...
import pe.com.inetum.cop.mailer.Mailer;
...
import pe.com.inetum.cop.strategy.MyStrategy;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Mailer.send(mail -> mail.from("cbelloda@gmail.com")
        .to("carlos.belloda@inetum.com")
        .body("el body")
        .adjunt("un djunto")
        .subject("un subject"));
    ...
    CustomerRepository.getAllCustomer().forEach(customer -> log.info(customer.toString()));
    ...
    // log.info("-------------------------------------------------");
    // log.info("" + new ServiceCustomer().getAll());

    // log.info("" + new ServiceCustomer().getCalculateResponse());
    // log.info("-----2-----------------");
    // log.info("" + new ServiceCustomer().getCalculateResponse2());
